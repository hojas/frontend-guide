function getWidth(width) {
  const el = document.querySelector('.boll-chart')
  // return width * 0.5
...
function _interpolateProjection(d3) {
  return (
...
function _projection(interpolateProjection, d3, scale, width, height, rotate) {
  width = getWidth(width)
  return (
