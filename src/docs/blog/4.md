...
// test
const arr = [1, 2, 3, 4, 5]
console.log(mySplice(arr, 1, 1, 3)) // [1, 3, 3, 4, 5]
```
...
// test
const arr = [1, 2, 3, 4, 5]
console.log(myToReversed(arr)) // [5, 4, 3, 2, 1]
```
...
// test
const arr = [1, 2, 3, 4, 5]
console.log(myToSplice(arr, 1, 1, 3)) // [1, 3, 3, 4, 5]
```
...
// test
const arr = [1, 2, 3, 4, 5]
console.log(myUnshift(arr, 6, 7)) // [6, 7, 1, 3, 3, 4, 5]
```
...
// test
const arr = [1, 2, 3]
console.log(myWith(arr, 1, 5)) // [1, 5, 3]
```
